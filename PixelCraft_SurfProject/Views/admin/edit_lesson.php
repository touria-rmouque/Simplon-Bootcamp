...
<div class="container admin-container">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5">
        <div>
            ...
            <h1 class="admin-title">Modifier la <span>Session</span></h1>
        </div>
    ...
    <div class="card-custom">
        <form action="index.php?page=admin_dashboard&action=updateLesson" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="title" class="form-control form-control-surf" 
                           ...
                           value="<?= htmlspecialchars($lesson['title']) ?>" placeholder="Ex: Perfectionnement Shortboard" required>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="datetime-local" name="lesson_date" class="form-control form-control-surf" 
                               style="border-radius: 0 15px 15px 0 !important;"
                               value="<?= date('Y-m-d\TH:i', strtotime($lesson['lesson_date'])) ?>" required>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="coach_name" class="form-control form-control-surf" 
                               style="border-radius: 0 15px 15px 0 !important;"
                               value="<?= htmlspecialchars($lesson['coach_name']) ?>" placeholder="Nom du moniteur" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <label class="small fw-bold text-muted mb-2 text-uppercase">Capacité Max</label>
                    <div class="input-group">
                        ...
                        <input type="number" name="max_students" class="form-control form-control-surf" 
                               style="border-radius: 0 15px 15px 0 !important;"
                               value="<?= $lesson['max_students'] ?>" min="1" required>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="price" class="form-control form-control-surf" 
                               style="border-radius: 0 15px 15px 0 !important;"
                               value="<?= $lesson['price'] ?>" placeholder="0.00" required>
                    </div>
                </div>
            </div>
